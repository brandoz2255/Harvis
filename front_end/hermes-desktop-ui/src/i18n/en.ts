...
export const en: Translations = {
  ...
  boot: {
    ready: 'Harvis Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Harvis settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Harvis backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Harvis Desktop…'
    },
    errors: {
      backgroundExited: 'Harvis background process exited.',
      backgroundExitedDuringStartup: 'Harvis background process exited during startup.',
    ...
    failure: {
      ...
      cloudDownTitle: 'Harvis Cloud agent is down',
      cloudDownDescription:
        'The Harvis-managed cloud agent this gateway connects to is returning a server error. It cannot be restarted from here — check its status, switch to the local gateway, or get support.',
      cloudDownHint:
        'The buttons below open the Harvis Portal (instance status and controls) and our Discord for support.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Harvis backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateHermes: 'Update Harvis',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Harvis Desktop.',
    ...
    native: {
      ...
      inputBody: 'Harvis is waiting for your response.',
      turnDoneTitle: 'Harvis finished',
      turnDoneBody: '',
  ...
  billingBlock: {
    titleNous: 'Out of Harvis credits',
  ...
  sendDiagnostics: {
    title: 'Send diagnostics to Harvis',
    privacyNotice:
      'This uploads a debug bundle to Harvis-internal storage (not a public paste). It includes system info (OS, versions, provider, which API keys are configured — never the keys themselves) and full agent, gateway, and desktop logs (up to 512 KB each), which likely contain conversation content, tool outputs, and file paths. Secrets are redacted before upload. The bundle is viewable only by Harvis staff and allowlisted Discord moderators, and auto-deletes after 14 days.',
    upload: 'Upload',
    uploading: 'Uploading…',
    cancel: 'Cancel',
    close: 'Close',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Harvis defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Harvis backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Harvis backend to manage this plugin from Desktop.',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Harvis is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Harvis asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Harvis was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Harvis was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Harvis follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Harvis can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by Harvis when it helps. Closing one retires it for good.',
      tipsReset: (count: number) => `Bring back ${count} closed ${count === 1 ? 'tip' : 'tips'}`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let Harvis walk you through the app, dimming the screen and spotlighting each step.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Harvis is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Harvis, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      heading: 'Harvis Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The Harvis runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      ...
      automaticUpdatesDesc:
        'Harvis checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Harvis configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Harvis.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Harvis gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Harvis Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Harvis Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Harvis runtime managed by this app.',
      kindRemoteDesc: 'A Harvis gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Harvis Cloud account.',
      kindSshDesc: 'A Harvis install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Harvis manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Harvis Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Harvis backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      ...
      localDesc: 'Start a private Harvis backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Harvis backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Harvis Cloud',
      cloudDesc: 'Sign in once to Harvis Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Harvis Cloud',
      cloudSignIn: 'Sign in to Harvis Cloud',
      cloudSignedIn: 'Signed in to Harvis Cloud',
      cloudNeedsSignIn: 'Sign in to Harvis Cloud to discover the agents on your account.',
      ...
      cloudNoAgents: {
        ...
        linkText: 'Harvis portal',
        after: ', then refresh.'
      },
      cloudRefresh: 'Refresh',
      cloudConnect: 'Connect',
      cloudConnecting: 'Connecting…',
      cloudDiscoverFailed: 'Could not load your Harvis Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Harvis Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Harvis Cloud',
      cloudSignedOutMessage: 'Cleared the Harvis Cloud session.',
      ...
      restartingMessage: 'Harvis Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Harvis ${version}` : ''}`,
      ...
      sshDesc:
        'Harvis is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'Harvis path (optional)',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Harvis found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Harvis runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Harvis is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the Harvis path.',
      sshErrPlatform:
        'Unsupported remote platform. Harvis Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Harvis on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Harvis. Review the exact configuration below — it comes from the link, not from Harvis.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Harvis runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Harvis at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    sessions: {
      ...
      defaultDirUpdated: 'Default project directory updated — start a new chat for it to take effect',
    ...
    toolsets: {
      ...
      nousIncluded: 'Included with a Harvis subscription — sign in to Harvis Portal to activate.',
      nousAuthNeededTitle: 'Sign in to Harvis Portal',
      nousAuthNeededMessage: provider => `${provider} is saved but won't activate until you sign in to Harvis Portal.`,
      nousAuthSignIn: 'Sign in',
      nousAuthDoneTitle: 'Harvis Portal connected',
      nousAuthDoneMessage: 'Your subscription backends are now active.',
      nousAuthFailed: 'Harvis Portal sign-in did not complete',
  ...
  starmap: {
    ...
    emptyDesc: 'As Harvis builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Harvis to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Harvis to generate pets.',
      backgroundHint: 'You can close this — Harvis will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Harvis desktop' },
    ...
    hermesActiveSessions: (version, count) => `Harvis ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Harvis you point it at, instead of this computer.',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Harvis environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Harvis did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Harvis will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Harvis backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Harvis. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Harvis backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Harvis...',
    placeholderReconnecting: 'Reconnecting to Harvis…',
    ...
    attachUrlDesc: 'Harvis will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Harvis to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Harvis…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Harvis…',
    ...
    unsupportedMessage: 'This version of Harvis can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Harvis is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Harvis backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Harvis from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Harvis will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Harvis desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Harvis updater takes over in its own window and reopens Harvis automatically when it’s done. Please don’t reopen Harvis yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Harvis reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Harvis reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Harvis?',
    blockerBody:
      'Harvis needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Harvis',
    foreignBlockerBody:
      'Harvis can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Harvis can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Harvis needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Harvis Desktop',
    setupChoiceDesc:
      'Connect this app to a Harvis gateway you already run, or install Harvis locally on this computer.',
    connectExistingTitle: 'Connect to existing Harvis',
    ...
    installLocalTitle: 'Install Harvis locally',
    installLocalDesc: 'Download Harvis, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Harvis Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Harvis',
    remoteSetupDesc: 'Enter your gateway URL. Harvis Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Harvis gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/hermes',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Harvis gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Harvis Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Harvis CLI or desktop instance is running. Stop any running Harvis instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Harvis installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Harvis Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Harvis is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Harvis…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Harvis',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Harvis at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Harvis connects automatically',
    ...
    authorizeThere: 'Authorize Harvis there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Harvis there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid Harvis subscription.',
    free: 'Free',
    freeTier: 'Free tier',
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Harvis Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Harvis Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Harvis will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Harvis is restarting...',
      askRestart: 'Ask Harvis to restart the server',
      lookingRestart: taskId => `Harvis is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Harvis is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Harvis to open a page.',
      finishedRestarting: message => `Harvis finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Harvis could not restart the server.',
      stillWorking:
        'Harvis is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Harvis is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Harvis gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Harvis won’t ask again for commands like this — in this session or any future one.`,
    ...
    mcpSetup: {
      ...
      catalogSource: 'From the Harvis-approved catalog',
  ...
  prompts: {
    ...
    sudoDesc: 'Harvis needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Harvis needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Harvis Desktop to use Save Image.',
    restartToSaveImages: 'Restart Harvis Desktop to save images',
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Harvis loads when the work calls for them.'
      },
      messaging: {
        title: 'Harvis away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Harvis made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Harvis — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
