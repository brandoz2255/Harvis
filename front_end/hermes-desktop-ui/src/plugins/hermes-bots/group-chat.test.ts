...
describe('speaker labels', () => {
  it('the default profile speaks as Harvis in transcripts, not @default', async () => {
    ...
    expect(line).toBe('Harvis: hello room')
  ...
  it('honor friendly identity: Bot Mode title, then display_name, never a stale Harvis', async () => {
    ...
    expect(chat.groupSpeakerLabel('default')).toBe('Harvis')
