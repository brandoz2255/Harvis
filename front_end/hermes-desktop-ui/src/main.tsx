// Side-effect: installs the browser `window.hermesDesktop` bridge. MUST stay the
// first import — modules below read `hermesDesktop` as they evaluate, and imports
// are hoisted, so import ORDER is the only thing that sequences this correctly.
import './lib/desktop-shim'
import './styles.css'
